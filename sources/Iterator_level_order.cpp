...
namespace ariel
{
    ...
    OrgChart::Iterator_level_order::Iterator_level_order(const OrgChart::Iterator_level_order &other)
    {
    }
    ...
    const OrgChart::Iterator_level_order OrgChart::Iterator_level_order::operator++(int)
    {
        return *this;
    }
